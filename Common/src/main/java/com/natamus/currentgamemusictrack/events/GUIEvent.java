...
public class GUIEvent {
	...
	private static void drawText(Font font, GuiGraphicsExtractor guiGraphics, String content, int x, int y, Color colour, boolean drawShadow) {
		if (Variables.guiOpacity > 10 && !content.equals("")) {
			guiGraphics.text(font, Component.literal(content), x, y, colour.getRGB(), drawShadow);
		}
	}
}